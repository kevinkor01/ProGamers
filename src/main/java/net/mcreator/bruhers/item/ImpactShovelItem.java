...
public class ImpactShovelItem extends BruhersModElements.ModElement {
	@ObjectHolder("bruhers:impact_shovel")
	public static final Item block = null;
	public ImpactShovelItem(BruhersModElements instance) {
		super(instance, 35);
	}
