...
public class CobaltPickaxeItem extends BruhersModElements.ModElement {
	@ObjectHolder("bruhers:cobalt_pickaxe")
	public static final Item block = null;
	public CobaltPickaxeItem(BruhersModElements instance) {
		super(instance, 12);
	}
