...
public class ImpactHoeItem extends BruhersModElements.ModElement {
	@ObjectHolder("bruhers:impact_hoe")
	public static final Item block = null;
	public ImpactHoeItem(BruhersModElements instance) {
		super(instance, 36);
	}
