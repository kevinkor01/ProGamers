...
public class ImpactAxeItem extends BruhersModElements.ModElement {
	@ObjectHolder("bruhers:impact_axe")
	public static final Item block = null;
	public ImpactAxeItem(BruhersModElements instance) {
		super(instance, 33);
	}
