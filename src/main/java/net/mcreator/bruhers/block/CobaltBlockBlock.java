...
public class CobaltBlockBlock extends BruhersModElements.ModElement {
	@ObjectHolder("bruhers:cobalt_block")
	public static final Block block = null;
	public CobaltBlockBlock(BruhersModElements instance) {
		super(instance, 8);
	}
